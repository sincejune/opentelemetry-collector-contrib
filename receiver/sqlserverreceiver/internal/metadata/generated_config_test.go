		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SqlserverQueryCallingService:                MetricConfig{Enabled: true},
					SqlserverQuerySample:                        MetricConfig{Enabled: true},
					SqlserverQuerySample2:                       MetricConfig{Enabled: true},
					SqlserverQuerySample3:                       MetricConfig{Enabled: true},
					SqlserverQueryTraces:                        MetricConfig{Enabled: true},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					...
					SqlserverQueryCallingService:                MetricConfig{Enabled: false},
					SqlserverQuerySample:                        MetricConfig{Enabled: false},
					SqlserverQuerySample2:                       MetricConfig{Enabled: false},
					SqlserverQuerySample3:                       MetricConfig{Enabled: false},
					SqlserverQueryTraces:                        MetricConfig{Enabled: false},
