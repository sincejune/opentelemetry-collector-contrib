...
func TestLogsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			defaultEventsCount++
			allEventsCount++
			lb.RecordDbServerQuerySampleEvent(timestamp, 11, "db.namespace-val", "db.query.text-val", "db.system.name-val", "network.peer.address-val", 17, 29, "sqlserver.command-val", 18.100000, 27, 35.100000, 22.100000, 23, 32, 26.100000, "sqlserver.query_hash-val", "sqlserver.query_plan_hash-val", "sqlserver.query_start-val", 15, "sqlserver.request_status-val", 19, 20, 28.100000, 24, 37, "user.name-val", "sqlserver.wait_resource-val", 19.100000, "sqlserver.wait_type-val", 16, "client.address-val")
			defaultEventsCount++
			allEventsCount++
			lb.RecordDbServerTopQueryEvent(timestamp, 27.100000, "db.query.text-val", 25, 29, 30, 30, "sqlserver.query_hash-val", "sqlserver.query_plan-val", "sqlserver.query_plan_hash-val", 20, 28.100000, 24, "server.address-val", 11, "db.server.name-val")
