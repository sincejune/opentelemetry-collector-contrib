...
func (e *eventDbServerTopQuery) recordEvent(ctx context.Context, timestamp pcommon.Timestamp, dbSystemNameAttributeValue string, dbQueryTextAttributeValue string, mysqlStatementsTimeAttributeValue float64) {
	if !e.config.Enabled {
		return
	}
	lr := e.data.AppendEmpty()
	...
	lr.Attributes().PutStr("db.system.name", dbSystemNameAttributeValue)
	lr.Attributes().PutStr("db.query.text", dbQueryTextAttributeValue)
	lr.Attributes().PutDouble("mysql.statements.time", mysqlStatementsTimeAttributeValue)
}
...
func (lb *LogsBuilder) RecordDbServerTopQueryEvent(ctx context.Context, timestamp pcommon.Timestamp, dbSystemNameAttributeValue AttributeDbSystemName, dbQueryTextAttributeValue string, mysqlStatementsTimeAttributeValue float64) {
	lb.eventDbServerTopQuery.recordEvent(ctx, timestamp, dbSystemNameAttributeValue.String(), dbQueryTextAttributeValue, mysqlStatementsTimeAttributeValue)
}
